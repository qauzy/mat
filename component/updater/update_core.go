...
var (
	...
	baseURL       string = "https://github.com/cauyy/mat/releases/download/Prerelease-Alpha/mat"
	versionURL    string = "https://github.com/cauyy/mat/releases/download/Prerelease-Alpha/version.txt"
	packageURL    string
...
func init() {
	...
	if !strings.HasPrefix(C.Version, "alpha") {
		baseURL = "https://github.com/cauyy/mat/releases/latest/download/mat"
