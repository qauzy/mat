...
GOBUILD=CGO_ENABLED=0 go build -tags with_gvisor -trimpath -ldflags '-X "github.com/qauzy/mat/constant.Version=$(VERSION)" \
		-X "github.com/qauzy/mat/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
